...
export class HomePage extends LoginPage
{
    ...
    async addProductToCart(productName: string) {
        ...
        if (!productFound) {
            console.log(`Schritt 1 NICHT erfolgreich: Schade 😒 🤔 , Produkt "${productName}" wurde auf der Seite NICHT gefunden!`);
        ...
        await this.addToCartBtn.getByText() click({ force: true });
    }
