...
When('I Login with valid credentials', async function(){
    await page.locator('input[placeholder="Email"]').fill("playwrigtdem@gmail.com")
    await page.locator('input[placeholder="Password"]').fill("playwrightdemo@gmail.com")
...
When('I click on the logout button', async function () {
    await page.locator('//button[normalize-space()="or click here to logout."]')
