...
// 📸 Screenshot mit Datum/Uhrzeit im Namen speichern
 await page.screenshot({ path: `screenshots/${name}_${timestamp}.png`,fullPage: false})// await page.screenshot({ path: `screenshots/${name}_${timestamp}.png`,fullPage: true})
 console.log(`✅📸 Screenshot wurde erfolgreich gespeichert unter dem Namen: "${name}_${timestamp}.png"`);
