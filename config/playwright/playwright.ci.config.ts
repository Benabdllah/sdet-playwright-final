...
export default defineConfig({
  ...
  reporter: [
    ...
    //['json', { outputFile: 'reports/playwright/html/results.json' }],
    ["junit", { outputFile: "reports/junit/ci-e2e.xml" }],
    //['blob', { outputDir: 'reports/playwright/blob' }],
    //['junit', { outputFile: `reports/junit/junit-${SELECTED_ROLE}.xml` }]
  ...
  outputDir: "test-results/playwright/raw", // ← Standard, nicht ändern!
